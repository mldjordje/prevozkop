    ...
    <section className="relative isolate overflow-hidden bg-zinc-900 text-white">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="absolute inset-0 bg-gradient-to-br from-black/90 via-black/70 to-black/55 sm:from-black/82 sm:via-black/60 sm:to-black/35"
        />
      </AnimatePresence>
      <motion.div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex min-h-[70vh] max-w-6xl flex-col justify-center gap-6 px-4 py-16 sm:px-6 lg:px-8">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="space-y-6 rounded-2xl bg-black/55 p-4 shadow-2xl backdrop-blur-sm sm:rounded-none sm:bg-transparent sm:p-0 sm:shadow-none sm:backdrop-blur-0"
          >
            ...
            <div className="max-w-3xl space-y-4">
              ...
              <p className="text-pretty text-base text-gray-100 sm:text-lg sm:text-gray-200">
